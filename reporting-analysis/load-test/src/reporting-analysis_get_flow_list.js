...
export function teardown(data) {
	...
	for (let y = 0; y < creditor_institution_codes.length; y++) {
		for (let i = 0; i < flow_ids.length; i++) {
			...
			//let flowTableURL = `http://127.0.0.1:10002/devstoreaccount1/flows(PartitionKey='${creditor_institution_code}', RowKey='${flowId}')?sv=2018-03-28&se=2022-04-28T07%3A43%3A05Z&sp=raud&sig=r%2BxFNget0aJ1DXu7%2BuFDlgS5%2Bo8QH0iO9S2KNQy2YwM%3D&tn=flows`;
