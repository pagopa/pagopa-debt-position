...
public interface IDebtPositionController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Conflict: duplicate debt position found.", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemJson.class))),
            @ApiResponse(responseCode = "500", description = "Service unavailable.", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemJson.class)))})
    @PostMapping(value = "/organizations/{organizationfiscalcode}/debtpositions/bulk",
            produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Operation(summary = "The Organization updates multiple debt positions.", security = {@SecurityRequirement(name = "ApiKey"), @SecurityRequirement(name = "Authorization")}, operationId = "updateMultiplePositions")
    @ApiResponses(value = {
    ...
    ResponseEntity<PaymentPositionModelBaseResponse> getDebtPositionByIUV(
            ...
            @Pattern(regexp = "\\b\\w{0,35}\\b") @Parameter(description = "Payment Option IUV", required = true)
