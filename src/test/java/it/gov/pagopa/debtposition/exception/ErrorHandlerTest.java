...
class ErrorHandlerTest {
  ...
  static class SampleDto {
    ...
    @NotNull public String required;
  }
    ...
    public String odpPost(
      ...
      if ("app-unmapped-system".equals(mode)) {
        ...
        throw new AppException(
            HttpStatus.INTERNAL_SERVER_ERROR, "Internal error", "unexpected exception");
      }
  ...
  void odp_genericException_returnsSystem500() throws Exception {
    mvc.perform(
            post("/payment-options/organizations/70000000000/notices/123456")
                .param("mode", "error")
