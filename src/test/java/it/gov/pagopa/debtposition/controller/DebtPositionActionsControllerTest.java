...
class DebtPositionActionsControllerTest {
  ...
  void publishDebtPosition_to_valid_200() throws Exception {
    ...
    mvc.perform(
            post("/organizations/PBHVALID_12345678901/debtpositions")
    ...
    mvc.perform(
            get("/organizations/PBHVALID_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
    ...
    mvc.perform(
            post("/organizations/PBHVALID_12345678901/debtpositions/12345678901IUPDMOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  ...
  void publishDebtPosition_to_publish_200() throws Exception {
    ...
    mvc.perform(
            post("/organizations/PBHPUBLISH_12345678901/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.getMock5()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());

    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/PBHPUBLISH_12345678901/debtpositions/12345678901IUPDMOCK3")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    mvc.perform(
            post("/organizations/PBHPUBLISH_12345678901/debtpositions/12345678901IUPDMOCK3/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  void publishDebtPosition_custom_NAV_200() throws Exception {
    ...
    mvc.perform(
            post("/organizations/PBHVALID_NAV_12345678901/debtpositions")
    ...
    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/PBHVALID_NAV_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    // porto in pubblicata/validata lo stato della posizione debitoria
    mvc.perform(
            post("/organizations/PBHVALID_NAV_12345678901/debtpositions/12345678901IUPDMOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  ...
  void publishDebtPosition_409() throws Exception {
    // creo una posizione debitoria (senza 'validity date' impostata)
    mvc.perform(
            post("/organizations/PBH409_12345678901/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.getMock1()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());
    ...
    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/PBH409_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    // porto in pubblicata/validata lo stato della posizione debitoria
    mvc.perform(
            post("/organizations/PBH409_12345678901/debtpositions/12345678901IUPDMOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  ...
  void publishDebtPosition_404() throws Exception {
    ...
    mvc.perform(
            post("/organizations/PBH_12345678901/debtpositions/12345678901IUPD404MOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
  ...
  void publishDebtPosition_min_due_date_409() throws Exception {
    ...
    // creo una posizione debitoria (senza 'validity date' impostata) e con due_date di pochissimo
    // più grande della current_date
    mvc.perform(
            post("/organizations/PBH409DUEDATE_12345678901/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.get409_Min_Due_Date_Mock1()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());

    // recupero la posizione debitoria e verifico lo stato
    mvc.perform(
            get("/organizations/PBH409DUEDATE_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    // porto in pubblicata lo stato della posizione debitoria => devo ottenere 409 per il fatto che
    // currentDate > due_date
    mvc.perform(
            post("/organizations/PBH409DUEDATE_12345678901/debtpositions/12345678901IUPDMOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isConflict());
  }
  ...
  void publishDebtPosition_min_valid_date_409() throws Exception {
    ...
    // creo una posizione debitoria (con 'validity date' impostata) e con due_date di pochissimo più
    // grande della current_date
    mvc.perform(
            post("/organizations/PIVA12345678/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.get409_Valid_Date_Mock1()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());

    // recupero la posizione debitoria e verifico lo stato
    mvc.perform(
            get("/organizations/PIVA12345678/debtpositions/12345678901IUPDMOCK4")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    // currentDate > due_date
    mvc.perform(
            post("/organizations/PIVA12345678/debtpositions/12345678901IUPDMOCK4/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isConflict());
  }

  @Test
  void publishDebtPosition_segregationCodes_200() throws Exception {
    ...
    // creo una posizione debitoria (senza 'validity date' impostata)
    mvc.perform(
            post("/organizations/PBHVALID_SC_12345678901/debtpositions")
    ...
    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/PBHVALID_SC_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  @Test
  void publishDebtPosition_segregationCodes_403() throws Exception {
    String notSufficientSegregationCode = "99";
    // creo una posizione debitoria (senza 'validity date' impostata)
    mvc.perform(
            post("/organizations/PBHVALID_403_SC_12345678901/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.getMock1()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());
    ...
    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/PBHVALID_403_SC_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  void invalidateDebtPosition_200() throws Exception {
    // creo una posizione debitoria (senza 'validity date' impostata)
    mvc.perform(
            post("/organizations/INVALIDATE_12345678901/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.getMock1()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());
    ...
    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/INVALIDATE_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    // porto in pubblicata/validata lo stato della posizione debitoria
    mvc.perform(
            post("/organizations/INVALIDATE_12345678901/debtpositions/12345678901IUPDMOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    ...
    mvc.perform(
            post("/organizations/INVALIDATE_12345678901/debtpositions/12345678901IUPDMOCK1/invalidate")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  void invalidateDebtPosition_Custom_NAV_200() throws Exception {
    ...
    // recupero la posizione debitoria e verifico lo stato in draft
    mvc.perform(
            get("/organizations/INVALIDATE_NAV_12345678901/debtpositions/12345678901IUPDMOCK1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
    ...
    // porto in pubblicata/validata lo stato della posizione debitoria
    mvc.perform(
            post("/organizations/INVALIDATE_NAV_12345678901/debtpositions/12345678901IUPDMOCK1/publish")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  ...
  void invalidateDebtPosition_409() throws Exception {
    ...
    mvc.perform(
            post("/organizations/INVALIDATE409_12345678901/debtpositions")
                .content(TestUtil.toJson(DebtPositionMock.getMock1()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isCreated());
  ...
  @Test
  void invalidateDebtPosition_segregationCodes_200() throws Exception {
    PaymentPositionDTO paymentPositionDTO = DebtPositionMock.getMock1();
    String segregationCode = paymentPositionDTO.getPaymentOption().get(0).getIuv().substring(0, 2);
    // creo una posizione debitoria (senza 'validity date' impostata)
    mvc.perform(
  ...
  @Test
  void invalidateDebtPosition_segregationCodes_403() throws Exception {
    PaymentPositionDTO paymentPositionDTO = DebtPositionMock.getMock1();
    String segregationCode = paymentPositionDTO.getPaymentOption().get(0).getIuv().substring(0, 2);
    String notSufficientSegregationCode = "99";
    // creo una posizione debitoria (senza 'validity date' impostata)
