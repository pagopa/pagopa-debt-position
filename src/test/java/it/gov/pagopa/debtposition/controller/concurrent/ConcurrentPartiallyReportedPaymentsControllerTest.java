...
class ConcurrentPartiallyReportedPaymentsControllerTest {
	...
	void initDebtPosition_for_partially_reporting() throws Exception {
		...
		mvc.perform(post("/organizations/REPORT_Concurrent_Partially_Reported_12345678901/paymentoptions/"+auxDigit+"123456IUVMULTIPLEMOCK8/pay")
		...
		mvc.perform(get("/organizations/REPORT_Concurrent_Partially_Reported_12345678901/debtpositions/12345678901IUPDMULTIPLEMOCK8")
				.contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
