...
class ExpiredPositionsSchedulerTest {
    ...
    void manualChangeDebtPositionStatusToValid() throws Exception {
        ...
        mvc.perform(
                        get("/v3/organizations/SCHEDULEVALID_12345678901/debtpositions/12345678901IUPDMOCK3")
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void manualChangeDebtPositionStatusToValidAfterDueDate() throws Exception {
        ...
        // verifico che lo stato sia stato effettivamente aggiornato a PUBLISHED
        mvc.perform(
                        get("/v3/organizations/SCHEDULEVALIDAFTERDUEDATE_12345678901/debtpositions/12345678901IUPDMOCK3")
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(
    ...
    void manualChangeDebtPositionStatusToExpiredAfterDueDate() throws Exception {
        ...
        mvc.perform(
                        post("/organizations/SCHEDULEEXP_12345678901/debtpositions")
                                .content(TestUtil.toJson(DebtPositionMock.getMock7()))
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isCreated());
        ...
        // verifico che lo stato sia stato effettivamente aggiornato a PUBLISHED
        mvc.perform(
                        get("/v3/organizations/SCHEDULEEXP_12345678901/debtpositions/12345678901IUPDMOCK3")
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(
    ...
    void manualChangeDebtPositionStatusToExpiredAndUpdateAllowed() throws Exception {
        ...
        // verifico che lo stato sia stato effettivamente aggiornato a PUBLISHED
        mvc.perform(
                        get("/v3/organizations/SCHEDULEEXPANDUPD_12345678901/debtpositions/12345678901IUPDMOCK3")
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(
