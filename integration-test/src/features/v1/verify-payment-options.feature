...
Feature: Verify payment options by NAV
  ...
  Scenario: 200 - grouping single and plan, descriptions and ordering
    ...
    And there is at least one group with 1 installment and null po description
    And there is at least one group with more than 1 installment and null po description
